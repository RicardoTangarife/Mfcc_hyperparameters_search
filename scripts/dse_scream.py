...
NExp = 1033              #1              #Identificación con número de experimento
samplerate = 22050
longitudMaxAudio = 4
...
valuesNfft = [1024, 2048, 4096]    #[256, 512, 1024, 2048, 4096]   #Valores de parametro a variar para la longitud de la FFT
